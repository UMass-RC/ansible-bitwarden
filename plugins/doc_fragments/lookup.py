class ModuleDocFragment(object):
    ...
    #     _terms:
    #       description:
    #         - single element list containing bitwarden record name
    #       type: list
    #       elements: str
    #     default_bw_collection_id:
    #       description: if no collection ID is given to a task, use this one by default
    #       ini:
    #         - section: bitwarden
    #           key: default_bw_collection_id
    #       env:
    #         - name: DEFAULT_BW_COLLECTION_ID
    #           required: false
    #           type: string
    # attributes:
    #   check_mode:
    ...
    #   diff_mode:
    #     support: none
    # extends_documentation_fragment: community.general.bitwarden
    # seealso: community.general.bitwarden
    # """
    ...
    author: Simon Leary (@simonLeary42)
    notes: []
    attributes:
      check_mode:
        description: operation is read only, no reason for check mode
        support: none
      diff_mode:
        description: operation is read only, no reason for diff mode
        support: none
    extends_documentation_fragment: community.general.bitwarden
    seealso:
